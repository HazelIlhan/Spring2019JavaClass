...
//10 is considered as int 10becomes 10L and store insinde long variabe 
		
		long lval=10;
// Autoboxing 10L will become new long 10L as object and assigned lRef 
		Long lRef=10L;
		
		// reference type does not care about he range it only care about erlationship between types
		// range compatible assignment only works for primitive numbers
	
		//Long lRef2=new Integer(10); // this code will not work 
		
 //we are trying to long ref aand store in long value 
		// Thisalways mislead programmeer to think as bbelow
