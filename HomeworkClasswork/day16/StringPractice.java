...
public class StringPractice {
	...
	public static void main(String[] args) {
		...
		//System.out.println(last );//benim denemem
	//System.out.println(beforeLast  ); //benim denemem
		System.out.println(beforeLast +""+ last );  // a ve y birlestirerek yazmak icin araya onu koydu ve sonuc ay cikiyor
